...
public class GameCanvasController : MonoBehaviour {
    ...
    public void CalibrationStart()  // Используется для кнопки Calibration в меню игры с ракетой
    {
    ...
    public void StartPython()   // Используется для кнопки Start the Game в меню игры с ракетой
    {
